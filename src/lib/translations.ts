...
const t = {
  en: {
    ...
    projectDescriptions: [
      ...
      "Bilingual (EN/PT-BR) interactive encyclopedia of the great schools of philosophy. Built with Next.js 14, TypeScript and React Three Fiber, it features AI-generated philosopher portraits, rotatable 3D busts on detail pages, isometric city scenes, a 138-question quiz bank with randomized rounds, and a bibliography of essential works per school — all installable as a PWA.",
  ...
  pt: {
    ...
    projectDescriptions: [
      ...
      "Enciclopédia interativa e bilíngue (EN/PT-BR) das grandes escolas filosóficas. Desenvolvida com Next.js 14, TypeScript e React Three Fiber, traz retratos de filósofos gerados por IA, bustos 3D rotacionáveis nas páginas individuais, ilustrações isométricas por escola, banco de 138 questões com rodadas aleatórias e uma bibliografia de obras essenciais — tudo instalável como PWA.",
